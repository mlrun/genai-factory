...
import { projectsAtom, projectsLoadingAtom, projectsWithFetchAtom } from '@atoms/projects'
        ...
        <VStack spacing={6} align="start">
          <Flex width='100%' justifyContent={'space-between'}>
            ...
            <Flex gap={4}>
              ...
              <Button colorScheme="blue" alignSelf="end" onClick={handleOpenPlayground}>
                Open Playground
              </Button>
            </Flex>
          </Flex>
          ...
          <SimpleGrid columns={[1, null, 2]} spacing={6} w="100%">
            {projects.map((project) => (
              <ProjectCard key={project.uid ?? project.name} project={project} />
            ))}
          </SimpleGrid>

        </VStack>
      </Container>
      <AddEditProjectModal isOpen={isModalOpen} onClose={onModalClose} onSave={handleSave} />
    </Layout>
  );
}
